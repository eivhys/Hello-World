...
class InvitationDashboard < Administrate::BaseDashboard
  ...
  COLLECTION_ATTRIBUTES = [:user, :challenge, :id, :code].freeze

  # SHOW_PAGE_ATTRIBUTES
  # an array of attributes that will be displayed on the model's show page.
  SHOW_PAGE_ATTRIBUTES = [:user, :challenge, :id, :code, :created_at, :updated_at].freeze

  # FORM_ATTRIBUTES
  # an array of attributes that will be displayed
  # on the model's form (`new` and `edit`) pages.
  FORM_ATTRIBUTES = [:user, :challenge, :code].freeze
