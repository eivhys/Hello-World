...
class ChallengeDashboard < Administrate::BaseDashboard
  ...
  COLLECTION_ATTRIBUTES = [:description, :levels, :id, :title].freeze

  # SHOW_PAGE_ATTRIBUTES
  # an array of attributes that will be displayed on the model's show page.
  SHOW_PAGE_ATTRIBUTES = [:description, :levels, :id, :title, :created_at, :updated_at].freeze

  # FORM_ATTRIBUTES
  # an array of attributes that will be displayed
  # on the model's form (`new` and `edit`) pages.
  FORM_ATTRIBUTES = [:description, :levels, :title].freeze
