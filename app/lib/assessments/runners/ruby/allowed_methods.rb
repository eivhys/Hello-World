  ...
  module Runners
    module Ruby
      module AllowedMethods
        IO_S_METHODS = ["new", "foreach", "open"].freeze

        KERNEL_S_METHODS = ["Array", "binding", "block_given?", "catch", "chomp", "chomp!", "chop", "chop!", "eval",
                            "fail", "Float", "format", "global_variables", "gsub", "gsub!", "Integer", "iterator?", "lambda", "local_variables", "loop", "method_missing", "proc", "raise", "scan", "split", "sprintf", "String", "sub", "sub!", "throw",].freeze

        SYMBOL_S_METHODS = ["all_symbols"].freeze

        STRING_S_METHODS = ["new"].freeze

        KERNEL_METHODS = ["==", "ray", "nding", "ock_given?", "tch", "omp", "omp!", "op", "op!", "ass", "clone", "dup",
                          "eql?", "equal?", "eval", "fail", "Float", "format", "freeze", "frozen?", "global_variables", "gsub", "gsub!", "hash", "id", "initialize_copy", "inspect", "instance_eval", "instance_of?", "instance_variables", "instance_variable_get", "instance_variable_set", "instance_variable_defined?", "Integer", "is_a?", "iterator?", "kind_of?", "lambda", "local_variables", "loop", "methods", "method_missing", "nil?", "private_methods", "print", "proc", "protected_methods", "public_methods", "raise", "remove_instance_variable", "respond_to?", "respond_to_missing?", "scan", "send", "singleton_methods", "singleton_method_added", "singleton_method_removed", "singleton_method_undefined", "split", "sprintf", "String", "sub", "sub!", "taint", "tainted?", "throw", "to_a", "to_s", "type", "untaint", "__send__",].freeze

        NILCLASS_METHODS = ["&", "inspect", "nil?", "to_a", "to_f", "to_i", "to_s", "^", "|"].freeze

        SYMBOL_METHODS = ["===", "id2name", "inspect", "to_i", "to_int", "to_s", "to_sym"].freeze

        TRUECLASS_METHODS = ["&", "to_s", "^", "|"].freeze

        FALSECLASS_METHODS = ["&", "to_s", "^", "|"].freeze

        ENUMERABLE_METHODS = ["all?", "any?", "collect", "detect", "each_with_index", "entries", "find", "find_all",
                              "grep", "include?", "inject", "map", "max", "member?", "min", "partition", "reject", "select", "sort", "sort_by", "to_a", "zip",].freeze

        STRING_METHODS = ["%", "*", "+", "<<", "<=>", "==", "=~", "capitalize", "capitalize!", "casecmp", "center",
