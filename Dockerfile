...
LABEL maintainer="Eivind Hystad <eivhys@gmail.com>"

RUN apt-get update -y && apt-get install -y nodejs postgresql-client npm lsb-release wget software-properties-common clang-format graphviz
